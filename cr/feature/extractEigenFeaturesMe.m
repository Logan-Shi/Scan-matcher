function [features, validIndices] = extractEigenFeaturesMe(ptCloudIn, varargin)
...
if(isempty(keyInds))
    ...
    % Compute features
    features = EigenExtractor(ptCloud, searchMethod, numNeighbors, radius, keyInds,weight);
end

% -------------------------------------------------------------------------
% Process PointCloud and extract descriptor for each point in it.
% -------------------------------------------------------------------------
function tsFeatures = EigenExtractor(ptCloudIn, searchMethod, numNeighbors, radius, keyInds,weight)
...
% Estimate features
tsFeatures = extractEigen(newCloud, keyInds,numNeighbors,weight);
