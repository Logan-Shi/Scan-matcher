function R = ransacSolveR(src,dst,cbar2,noise_bound,max_iteration,outlier_per,is_graph)
...
sample_size = 3;
max_iteration = min(max(log(1-credibility)/log(1-inlier_percentage^sample_size),1000),max_iteration);
counter = 0;
R = eye(3);
least_error = inf;
